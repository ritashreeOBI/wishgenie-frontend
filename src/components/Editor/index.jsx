...
function Editor({ path }) {
    ...
    return (
        ...
        <div className='editor mb-10 m-2 w-full h-full bg-white rounded-xl drop'>
            ...
            <div className='editDetail grid grid-cols-4'>
                <div className='flex flex-col gap-2  items-center col-span-3 pl-4  '>
                    <div className=' w-full h-[500px] shadow-md   flex justify-center rounded-lg relative'>
                         <Image src={path} width={250} height={500} /> 
