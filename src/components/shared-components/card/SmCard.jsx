...
function SmCard({ pro  ,setModalView }) {
    ...
    return (
        ...
        <div
            className=" w-[300px] grow rounded-xl bg-white  overflow-hidden  relative"
            onClick={ViewHandler}
        ...
        >
            ...
            <div className=' flex justify-center items-center h-[250px]  overflow-hidden '>
                <Image
                    src={thumbnail || image} alt="product" width={300} height={300} className='' />
            </div>
            <div className='h-full p-2 '>
                <div className='flex flex-col h-[150px] detail'>
