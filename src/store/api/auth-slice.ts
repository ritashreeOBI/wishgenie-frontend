import { ILoginPayload, ILoginResponse, IRegisterPayload, IRegisterResponse } from '@/editor-components/types/auth';
import { logout, login } from '../slices/editor/auth-slice';
