...
import { StageImageFilterValues } from '@/editor-components/types/stage-object';
import { FilterName, FilterValue, RGB_FILTERS, StageImageData } from '@/editor-components/types/stage-object';
...
const ImageFilters = ({ imageId, data }: Props) => {
  ...
  return (
    <Box>
      <Menu>
        <MenuButton as={Button} rightIcon={<ChevronDownIcon />} fontWeight={'medium'} fontSize={14}>
          Filters
        </MenuButton>
        <MenuList sx={{ p: 6 }}>
