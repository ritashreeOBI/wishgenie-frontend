...
import useRequestHandler from '@/editor-components/hooks/use-request-handler';
import { useUpdateCanvasMutation } from '@/store/api/canvas-slice';
import { ICanvasPayload } from '@/editor-components/types/canvas';
import { ICreate, createSchema } from '@/editor-components/validation/canvas';
