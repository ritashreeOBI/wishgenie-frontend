...
import useFontFaceObserver from '@/editor-components/Studio/objects/TextObject/use-font-face-observer';
import { StageTextObjectData } from '@/editor-components/types/stage-object';
