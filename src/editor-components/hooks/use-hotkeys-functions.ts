...
import { stateObjectActions, stageObjectSelector } from '@/store/slices/editor/stage-object-slice';
import { copiedObjectActions, copiedObjectSelector } from '@/store/slices/editor/copied-objects-slice';
